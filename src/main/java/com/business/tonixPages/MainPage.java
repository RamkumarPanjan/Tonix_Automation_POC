...
public class MainPage extends BasePage {
    ...
    public void clickTotalStashBalance() throws Exception {
        ...
        if(ifElementPresent(MainSelectors.txtStashes, "'Stashes' text")) {
            waitForElementAndClickIfPresent(MainSelectors.txtStashes, 10,"Click 'Stashes' text in main page");
            ...
            waitForElementAndClickIfPresent(MainSelectors.txtPutYourStashInCash, 10,"Click 'Put your stash in cash' text in main page");
